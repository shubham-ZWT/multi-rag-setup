...
router.get("/:embedKey/config", async (req: Request, res: Response) => {
  try {
...
router.post("/:embedKey/chat", async (req: Request, res: Response, next: NextFunction) => {
  try {
    const embedKey = req.params.embedKey as string;
...
router.post("/:embedKey/feedback", async (req: Request, res: Response) => {
  try {
    const embedKey = req.params.embedKey as string;
